...
2. **Thin third-party-verifiable proof, partly closed.** Our trust surface was always real and founder-led: named founders, photographs, roles, direct mailboxes, a phone number and a full KVK block. That is stronger than six anonymous logos and should never have been described as an absence. The narrower gap was proof a stranger can check without meeting us, and two credentials now sit on the About page and in `llms.txt`: Exact Online Premium Partner and Microsoft AI Cloud Partner. What is still missing is customer-side proof: no named client, no case study, no quantified outcome from a real engagement. Claridy has six logos and nothing behind them, so this is a low bar to clear.
