...
export interface ArticleContent {
  ...
  /**
   * YouTube video for the article. Rendered in the hero slot instead of the
   * hero image; the hero image then serves as the share card, the listing
   * thumbnail and the video poster in the JSON-LD.
   */
...
export const articles: Record<ArticleKey, Article> = {
  ...
  cashflowprognose: {
    ...
    nl: {
      ...
      video: { id: 'yiIjpAwJCDI', title: 'Demo: een wekelijkse cashflowprognose uit Exact Online met Claude' },
      blocks: [
        {
          type: 'p',
    ...
    en: {
      ...
      video: { id: 'yiIjpAwJCDI', title: 'Demo: a weekly cashflow forecast from Exact Online with Claude (Dutch spoken)' },
      blocks: [
        {
          type: 'p',
